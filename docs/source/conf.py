...
nitpick_ignore = [
    ...
    ('py:class', '2-tuple of ints'),
    ('py:class', 'array-like'),
    ('py:class', 'array_like'),
    ('py:class', 'array_like of floats'),
    ('py:class', 'boolean'),
    ('py:class', 'cupy.dtype'),
    ('py:class', 'cupy.float32'),
    ('py:class', 'cupy.ndarray of bool'),
    ('py:class', 'cupy.ndarray of int'),
    ('py:class', 'cupy.ndarray of ints'),
    ('py:class', 'dtype object'),
    ('py:class', 'file'),
    ...
    ('py:class', '-inf'),
    ('py:class', 'ints'),
    ('py:class', 'list of arrays'),
    ('py:class', 'list of dtypes'),
    ('py:class', 'list of order'),
    ('py:class', 'list of str'),
    ('py:class', 'module'),
    ('py:class', 'None'),
    ('py:class', 'non-zero int'),
    ('py:class', 'numpy.float32'),
    ('py:class', 'numpy.float64'),
    ('py:class', 'optional'),
    ('py:class', 'scalar'),
    ('py:class', 'sequence'),
    ('py:class', 'sequence of arrays'),
    ('py:class', 'sequence of int'),
    ('py:class', 'sequence of ints'),
    ('py:class', 'size_t'),
    ('py:class', 'string'),
    ('py:class', 'tuple of 2 ints'),
    ('py:class', 'tuple of arrays'),
    ('py:class', 'tuple of Exception'),
    ('py:class', 'tuple of ints'),
    ('py:class', 'tuple of int'),
    ('py:class', 'tuple of ndarray'),
    ('py:class', 'tuple of ndarrays'),
    ('py:class', 'tuple of str'),
    ('py:class', 'uint32'),
    ('py:class', '\'A\''),
    ('py:class', '\'C\''),
    ('py:class', '\'F\''),
    ...
    ('py:class', '\'fro\''),
    ('py:class', '\'xy\''),
    ('py:func', 'cupy.ndarray.__getitem__'),
    ('py:func', 'cupy.ndarray.__setitem__'),
